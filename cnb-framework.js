	...
	if( !greenPictureLoaded || !normalPictureLoaded || timesExcamationBlinked < 4){
		...
		if( !picturesDisplayed ){// Displaying the pictures
			...
			if( !gameOn) {// If the Game is Over
				...
				tumblr_photo_caption = score + ' is my score on ' + gameTitle + ' ! Click on the picture to play to this fucking game !!!';					
				...
				$(".twitter-share-button").attr("data-text" , score + ' is my score on ' + gameTitle + ' ! ');
